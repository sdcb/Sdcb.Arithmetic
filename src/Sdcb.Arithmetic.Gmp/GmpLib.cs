...
public static class GmpLib
{
    ...
    /// <param name="p0">(C type: void*(size_t)) </param>
    /// <param name="p1">(C type: void*(void*,size_t,size_t)) </param>
    /// <param name="p2">(C type: void(void*,size_t)) </param>
    [DllImport(Dll)]
    ...
    /// <param name="p0">(C type: byte*) </param>
    /// <param name="p1" />
    /// <param name="p2">(C type: byte*) </param>
    [DllImport(Dll)]
    ...
    /// <param name="p1">(C type: size_t*) </param>
    /// <param name="p2" />
    /// <param name="p3" />
    /// <param name="p4" />
    /// <param name="p5" />
    /// <param name="p6">(C type: mpz_srcptr) </param>
    [DllImport(Dll)]
    ...
    /// <param name="p0">(C type: mpz_ptr) </param>
    /// <param name="p1">(C type: mpz_ptr) </param>
    /// <param name="p2">(C type: mpz_ptr) </param>
    /// <param name="p3">(C type: mpz_srcptr) </param>
    /// <param name="p4">(C type: mpz_srcptr) </param>
    [DllImport(Dll)]
    ...
    /// <param name="p4" />
    /// <param name="p5" />
    /// <param name="p6">(C type: void*) </param>
    [DllImport(Dll)]
    ...
    /// <param name="p2">(C type: mpq_srcptr) </param>
    [DllImport(Dll)]
    ...
    /// <param name="p0">(C type: mpq_ptr) </param>
    /// <param name="p1">(C type: mpq_ptr) </param>
    [DllImport(Dll)]
    ...
    /// <param name="p2" />
    /// <param name="p3" />
    /// <param name="p4">(C type: mpf_srcptr) </param>
    [DllImport(Dll)]
    ...
    /// <param name="p0">(C type: mp_ptr) </param>
    /// <param name="p1">(C type: mp_ptr) </param>
    /// <param name="p2">(C type: mp_size_t*) </param>
    /// <param name="p3">(C type: mp_ptr) </param>
    /// <param name="p4" />
    ...
    /// <param name="__gmp_a">(C type: mpz_srcptr) </param>
    [DllImport(Dll)]
    ...
    /// <param name="__gmp_w">(C type: mpq_ptr) </param>
    /// <param name="__gmp_u">(C type: mpq_srcptr) </param>
    [DllImport(Dll)]
