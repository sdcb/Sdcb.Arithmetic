...
public static class MpfrLib
{
    ...
    /// <param name="q">(C type: mpq_ptr) </param>
    /// <param name="f">(C type: mpfr_srcptr) </param>
    [DllImport(Dll)]
    ...
    /// <param name="p0">(C type: mpfr_exp_t*) </param>
    /// <param name="p1">(C type: mpfr_ptr) </param>
    /// <param name="p2">(C type: mpfr_srcptr) </param>
    /// <param name="p3">(C type: mpfr_rnd_t) </param>
    [DllImport(Dll)]
    ...
    /// <param name="p2" />
    /// <param name="p3" />
    /// <param name="p4">(C type: mpfr_srcptr) </param>
    /// <param name="p5">(C type: mpfr_rnd_t) </param>
    [DllImport(Dll)]
    public static extern IntPtr mpfr_get_str(IntPtr p0, IntPtr p1, int p2, nint p3, IntPtr p4, mpfr_rnd_t p5);

    /// <param name="z">(C type: mpz_ptr) </param>
    /// <param name="f">(C type: mpfr_srcptr) </param>
    /// <param name="p2">(C type: mpfr_rnd_t) </param>
    [DllImport(Dll)]
    ...
    /// <param name="p0">(C type: mpfr_ptr) </param>
    /// <param name="p1">(C type: mpfr_ptr) </param>
    /// <param name="p2">(C type: gmp_randstate_t) </param>
    /// <param name="p3">(C type: mpfr_rnd_t) </param>
    [DllImport(Dll)]
    ...
    /// <param name="p0">(C type: mpfr_ptr) </param>
    /// <param name="p1">(C type: mpfr_ptr*) </param>
    /// <param name="p2">(C type: mpfr_ptr*) </param>
    /// <param name="p3" />
    /// <param name="p4">(C type: mpfr_rnd_t) </param>
    [DllImport(Dll)]
    ...
    /// <param name="p0">(C type: mpfr_free_cache_t) </param>
    [DllImport(Dll)]
